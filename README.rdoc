...
* Permitir la reserva de aulas por docentes, pero la aprobación de los pedidos la realizará un rol diferente que llamaremos Celador

* Permitir al celador agregar nuevas aulas

* Los usuarios deberán autenticarse usando sus cuentas de Google, Twitter y/o Facebook

* La gestión de aulas (recursos), se realizará por medio de la API de recursos
...
*** Un tiempo X en horas configurable, antes que una reserva aprobada se cumpla
...
* PUT /resources/:id actualiza los datos de un recursoesarrollar una aplicación Rails para Gestión de Aulas